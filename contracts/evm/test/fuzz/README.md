...
| **FEE-01**                  | **P1**   | Yes             | **Covered**           | `invariants/FEE01.sol` → `echidna_fee_01_queue_vs_pot`, `echidna_fee_01_materialise_updates_pot_only`                                          | Queue-vs-materialised fee pot accounting; each action resets CSI epoch/factor baseline (single Echidna instance).                                                                 |
