...
| **COV-02**                  | **P2**   | Yes             | Not started           | —                                                                                                                                              | Sequencing: coverage burns must be settled before modifies.                                               |
...
| **FEE-02**                  | **P2**   | Yes             | Not started           | —                                                                                                                                              | “New positions don’t get bonuses on creation” is a tricky edge case.                                      |
| **VTS-02**                  | **P2**   | Yes             | Not started           | —                                                                                                                                              | Tick-cross flip identity; easy to regress with accounting refactors.                                      |
| **VTS-03**                  | **P2**   | Yes             | Not started           | —                                                                                                                                              | Segment-based deficit/inflow growth accounting.                                                           |
| **DELTA-01**                | **P3**   | Yes             | Not started           | —                                                                                                                                              | End-of-batch delta netting; very hard to eyeball across flows.                                            |
...
| **SETTLE-01**               | **P1**   | Yes             | Not started           | —                                                                                                                                              | Withdrawals must revert while RFS open (unless seizing).                                                  |
