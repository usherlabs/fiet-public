...
/// @notice Echidna harness for the MM queue custody guard: when `tokenId > 0`, immediate post-`feeAdj` non-fee LCC
...
///         is an underfunded / inconsistent-coupling region, not ordinary `feeAdj` economics.
