...
pub enum Check {
    ...
    Slot0TickBounds { pool_id: FixedBytes<32>, min: i32, max: i32 },
    Slot0SqrtPriceBounds { pool_id: FixedBytes<32>, min: U256, max: U256 },

    RfsClosed { position_id: FixedBytes<32> },
    QueueLte { lcc: Address, owner: Address, max: U256 },
    ReserveGte { lcc: Address, min: U256 },
    SettledGte { position_id: FixedBytes<32>, min_amount0: U256, min_amount1: U256 },
    CommitmentDeficitLte { position_id: FixedBytes<32>, max_deficit0: U256, max_deficit1: U256 },
    GracePeriodGte { position_id: FixedBytes<32>, min_seconds: u64 },
