...
# command to deploy the contracts to a particular network, the output will be saved in the deployments directory(/solidity/deployments/oracle_deployments/<$1)
