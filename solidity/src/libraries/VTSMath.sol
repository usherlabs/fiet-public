...
library VTSMath {
    ...
    function vtsRequiredBps(uint256 out0, uint256 out1, uint256 c0, uint256 c1, uint128 liqPos, uint256 liqTotal)
        internal
        pure
        returns (uint256 req0Bps, uint256 req1Bps)
    {
        (uint256 allocOut0, uint256 allocOut1) = allocateOutflowProRata(out0, out1, uint256(liqPos), liqTotal);
