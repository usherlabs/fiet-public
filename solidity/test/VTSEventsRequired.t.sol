...
contract VTSEventsRequiredTest is Test {
    ...
    function test_getVTSRequired_settlementDecay_proportional() public {
        ...
        vm.prank(currency0);
        mgr.recordSettlementEvent(poolId, address(0xA), 0, int128(int256(D / 2)), D, bytes32(0), true);
    ...
    function test_ringReads_and_states() public {
        ...
        vm.prank(currency1);
        mgr.recordSettlementEvent(poolId, address(0xB), 1, int128(33), 77, bytes32(0), false);
    ...
    function test_deficit_and_settlement_readback_payloads() public {
        ...
        vm.prank(currency0);
        mgr.recordSettlementEvent(poolId, address(0xC0FFEE), 0, int128(600), 1200, bytes32(0), true);
