...
mod tests {
    ...
    #[test]
    fn test_arbitrum_constants() {
        let constants = NetworkConstants::arbitrum();
        assert_eq!(
        ...
        assert_eq!(constants.rpc_url, "https://arb1.arbitrum.io/rpc");
    }

    #[test]
    fn test_arbitrum_sepolia_constants() {
        let constants = NetworkConstants::arbitrum_sepolia();
        assert_eq!(
            constants.pool_manager,
        ...
        assert_eq!(constants.rpc_url, "https://sepolia-rollup.arbitrum.io/rpc");
    }

    #[test]
    fn test_eth_sepolia_constants() {
        let constants = NetworkConstants::eth_sepolia();
        assert_eq!(
            constants.pool_manager,
        ...
        assert_eq!(constants.rpc_url, "https://rpc.sepolia.org");
    }

    #[test]
    fn test_uniswap_actions() {
        let actions = UniswapActions::new();
        assert_eq!(actions.burn_position, 0x03);
        assert_eq!(actions.mint_position, 0x02);
        assert_eq!(actions.take_pair, 0x11);
    }
}
