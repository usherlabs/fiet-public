// reference: https://github.com/SorellaLabs/brontes/blob/main/crates/brontes-pricing/src/protocols/uniswap_v3/uniswap_v3_math/tick_math.rs
...
mod tests {
    ...
    #[test]
    fn test_get_sqrt_ratio_at_tick_zero() -> eyre::Result<()> {
    ...
    #[test]
    fn test_sqrt_ratio_at_tick_positive() -> eyre::Result<()> {
    ...
    #[test]
    fn test_sqrt_ratio_at_tick_negative() -> eyre::Result<()> {
        let sqrt = get_sqrt_ratio_at_tick(-1).unwrap();
